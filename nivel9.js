...
const levels = [
    [
        {
            question: "¿Cuál es el nombre del lugar donde vive Mario y Luigi?",
            options: ["Casa del Champiñón", "Casa del Hongo", "Casa del Fontanero", "Casa de la Princesa"],
            correctAnswer: "Casa del Hongo"
        },
